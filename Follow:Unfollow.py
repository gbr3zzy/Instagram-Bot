...
# login credentials
insta_username = 'givanne.nyc'
insta_password = 'poloking1995'
...
with smart_run(session):
  ...
  3500/4000 users for better results)...
   """
    session.follow_user_followers(['russellbrunson', 'grantcardone', 'garyvee'], amount=100,
    ...
    """
    session.follow_user_followers(['josephsoto', 'tailopez', 'tonyrobbins'], amount=800,
                                  randomize=False, interact=False)
